...
document.addEventListener("DOMContentLoaded", function() {
    ...
    episodeSelect.addEventListener('change', function() {
        ...
        const server1Url = `https://vidsrc.xyz/embed/tv/${seriesId}/${seasonNumber}/${episodeNumber}?sub_url=https%3A%2F%2Fvidsrc.me%2Fsample.srt&ds_langs=en,de`;
        const server2Url = `https://embed.smashystream.com/playere.php?tmdb=' + getParameterByName('id'))`;
        const server3Url =  `https://vidsrc.to/embed/tv/${seriesId}/${seasonNumber}/${episodeNumber}`;

        // Set the default embed URL to server1Url
        const embedUrl = server1Url;

        // Call switchEmbed with the default embed URL
